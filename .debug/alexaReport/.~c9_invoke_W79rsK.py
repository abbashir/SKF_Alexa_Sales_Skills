...
#corona update function
def Corona_intent_response():
    
    r = requests.get('https://coronavirus-tracker-api.herokuapp.com/v2/locations').json()
    confrim = r["latest"]["confirmed"]
    deaths = r["latest"]["deaths"]
    recovered = r["latest"]["recovered"]

    session_attributes = {}
    card_title = "Live Sales"
    speech_output = "Coronavirus Cases in the world " + str(korona_unit(confrim)) + " \n \n \n . . . . . . . . . . . . .. . . . Total Deaths is " + str(deaths) + " \n \n \n . . . . . . . . . . . . .. . . .Total recovered is " + str(recovered) 
    reprompt_text = "you can ask me by country."
    should_end_session = False
    return build_response(session_attributes, build_speechlet_response(
        card_title, speech_output, reprompt_text, should_end_session))

#corona update function
def CoronaByCountry_intent_response(intent):
    
    get_country = intent['slots']['country']['value']
    ...
    session_attributes = {}
    card_title = "Live Sales"
    speech_output = "Coronavirus Cases in " + str(get_country) +"is " + str(korona_unit(confirmed)) + " \n \n \n . . . . . . . . . . . . .. . . . Total Deaths is " + str(deaths) + " \n \n \n . . . . . . . . . . . . .. . . .Total recovered is " + str(recovered) 
    reprompt_text = "you can ask me by country."
    should_end_session = False
    return build_response(session_attributes, build_speechlet_response(
        card_title, speech_output, reprompt_text, should_end_session))        
...
def rsm_sales_intent_response(intent):
    ...
    sales = get_rsm_sales(rsm)
    mTarget = get_rsm_mTarget(rsm)
    dTarget = int(mTarget / days)
    trend = int(sales * trendTime)
    achievement = int((sales / dTarget) * 100)
    trendAchievement = int((trend / dTarget) * 100)
...
def on_intent(intent_request, session):
    ...
    # Dispatch to your skill's intent handlers  CoronaByCountry_intent_response
    
    #corona update
    if intent_name == "CoronaUpdate":
        return Corona_intent_response()
        
    #corona update By country
    elif intent_name == "CoronaByCountry":
        return CoronaByCountry_intent_response(intent)    

    # Sales - All Branch
    elif intent_name == "ALLBLSSLIntent":
