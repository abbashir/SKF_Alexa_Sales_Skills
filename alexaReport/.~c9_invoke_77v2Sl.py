...
def rsm_sales_intent_response(intent):
    ...
    sales = get_rsm_sales(2702)
    mTarget = get_rsm_mTarget(2702)
    ...
    # speech_output = "Your RSM " + str(rsm_name) + "--" + str(rsm) + "---" + str(sales)+ "---" + str(mTarget)+"---" + str(dTarget)+"--"+str(trend)+"---"+str(achievement)+"--"+str(trendAchievement)
